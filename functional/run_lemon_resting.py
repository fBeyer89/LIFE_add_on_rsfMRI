...
for subject in subjects:
    ...
    working_dir = '/scr/kennedy2/data_fbeyer/redo_subjects/WDR_add_on/'+subject+'/'
    #os.makedirs(working_dir)
    data_dir = '/scr/kennedy2/data_fbeyer/real/'+subject+'/'
    data_dir_WDR = '/scr/kennedy2/data_fbeyer/BIPS/WDR/Lemon_mod/'+subject+'/'
    #os.makedirs(data_dir)
    ##change this depending on location of freesurfer files
    freesurfer_dir = '/scr/kennedy2/LIFE/freesurfer_all/'
    
    resting_dir = '/scr/kennedy2/data_fbeyer/redo_subjects/'+subject+'/preprocessed/mod/resting/'
    ...
    pe_dir = 'y-'
    fwhm_smoothing = 6.0
    create_lemon_resting(subject=subject, working_dir=working_dir, data_dir=data_dir, data_dir_WDR=data_dir_WDR,
